          ...
          {article.category_id == 9 || article.category_id == 8 ? (
            ...
            <>
              <div className="p-3 text-white bg-danger rounded">
                ...
                <p>
                  Apabila dalam proses recuitment terdapat pemungutan biaya atau
                  disarankan menggunakan jasa travel dan sebagainya. Di harapkan
                  teman-teman tidak mengikutinya dan abaikan saja.
                </p>
                <p>
                  Pihak lokersubang.com tidak menyarankan itu semua. Karena pada
                  dasarnya, proses recruitment tidak memungut biaya sepeserpun.
                  Kecuali biaya akomodasi untuk mendatangi lokasi tes, maka itu
                  tanggung jawab pribadi masing-masing.
                </p>
                <p>
                  Dan apabila terjadi penipuan dll. lokersubang.com tidak akan
                  bertanggung jawab.
                </p>
              </div>
            </>
