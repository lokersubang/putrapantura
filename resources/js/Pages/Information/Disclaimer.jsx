    ...
    return (
        <div>
            ...
            <div className="p-4 rounded bg-white shadow-sm ">
                <Content>
                    <>
                        <h1>Disclaimer for Putra Pantura</h1>
                        <p>
                            ...
                            dadannurmaulana1@gmail.com. Our Disclaimer was
                            generated with the help of the .
                        </p>
                        <h2>Disclaimers for putrapantura.com</h2>
                        <p>
                            All the information on this website -
                            https://putrapantura.com - is published in good
                            faith and for general information purpose only.
                            putrapantura.com does not make any warranties about
                            ...
                            (putrapantura.com), is strictly at your own risk.
                            putrapantura.com will not be liable for any losses
                            and/or damages in connection with the use of our
                            website.
                        </p>
                        <p>
